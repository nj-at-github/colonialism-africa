...
log using "C:\Users\LIBDL-7\Documents\nj\colonialism\latest-noCameroonTogo-appendix-latest-an-all-tables.txt", t replace
...
************* drop Cameroon and Togo
drop if country ==  "Cameroon" | country ==  "Togo"
 
ta cid country if country == "Cameroon", nol
ta cid country if country == "Togo", nol

*drop if cid == 7 | cid == 46
...
outreg2 using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\appendix\noCameroonTogo\summary_stat", sum(log) see excel replace
...
outreg2 [level_main?] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\appendix\noCameroonTogo\appendix-table2_level",  see word replace
...
outreg2 [log_main?] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\appendix\noCameroonTogo\table2_log",  see word replace

*** Pooled or RE
reg log_alr $logcontrols log_govt_exp polityscore log_internet french british , vce(clus country)
xtreg log_alr $logcontrols log_govt_exp polityscore log_internet french british , re vce(clus country)
xttest0
