/*
*******************************************************************
***  .do file for Colonization- Africa paper ***
*******************************************************************
...
log using "C:\Users\LIBDL-7\Documents\nj\colonialism\latest-main-an-all-tables-`today'.txt", t replace


cap mkdir "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\"
...
outreg2 using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\summary_stat", sum(log) see word replace
...
outreg2 [level_main?] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\table2_level",  see word replace
...
outreg2 [log_main?] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\table2_log",  see word replace
...
xtreg log_alr $logcontrols log_govt_exp polityscore internet french british , re vce(clus country) 
est sto log_RE
outreg2 [level_pooled level_RE log_pooled log_RE] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\Pooled_RE_level_log",  see word replace


*Table 3. Mundalk // doesn't run with time series operator i.year
...
reg log_alr log_internet french british c.log_internet#britishcolony c.log_internet#frenchcolony , vce(clus cid)
est sto ols

xtreg log_alr log_internet french british c.log_internet#britishcolony c.log_internet#frenchcolony i.year, re vce(clus cid)
est sto logre

xtreg log_alr  $logcontrols log_govt_exp polityscore log_internet british french c.log_internet#britishcolony c.log_internet#frenchcolony i.year, re vce(clus cid)
est sto logcontrolre

xtreg log_alr log_internet french british c.log_internet#britishcolony c.log_internet#frenchcolony  i.year, fe vce(clus cid)
est sto logfe
...
outreg2 [no_inte_re_log_internet re_log_internet recontrols_log_internet fe_log_internet  fecontrols_log_internet] using "C:\Users\LIBDL-7\Documents\nj\colonialism\results\main\internet_interactions",  see word replace
